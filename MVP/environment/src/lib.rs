...
pub use facts::{
    ...
    EnvironmentHeadReadModel, EnvironmentHeadReference, EnvironmentSupersededHead,
    current_environment_head, decode_environment_branch_fact, decode_environment_head_fact,
