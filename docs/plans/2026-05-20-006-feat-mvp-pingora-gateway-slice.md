...
hyper gateway path as a first compatibility step. A gateway engine boundary now
exists and defaults to the existing hyper engine while the Pingora engine lands.
