...
Route protection is gateway-ingress state on a route binding. A provider-protected route may attach only when the referenced cluster-scoped access provider is usable, following ADR 0002.
