...
pub fn request_name(request: &ployz_api::DaemonRequest) -> &'static str {
    match request {
        ...
        ployz_api::DaemonRequest::MeshUp { .. } => "mesh_up",
        ployz_api::DaemonRequest::MeshDown => "mesh_down",
        ...
        ployz_api::DaemonRequest::MachineEnable { .. } => "machine_enable",
        ployz_api::DaemonRequest::MachineDrain { .. } => "machine_drain",
        ployz_api::DaemonRequest::MachineDisable { .. } => "machine_disable",
        ...
        ployz_api::DaemonRequest::MeshPromote { .. } => "mesh_promote",
        ployz_api::DaemonRequest::MeshStandby { .. } => "mesh_standby",
        ployz_api::DaemonRequest::MeshSetParticipation { .. } => "mesh_set_participation",
