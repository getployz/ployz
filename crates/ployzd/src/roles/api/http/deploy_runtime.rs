//! The Docker-facing runtime seam the deploy driver commands.
//!
//! The trait keeps every external container effect behind one narrow surface;
//! the blanket impl adapts the machine runner and owns the health-gate
...
use ployz_core::ids::{ContainerId, ServiceRowId};
