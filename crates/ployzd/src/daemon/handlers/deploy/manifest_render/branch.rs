...
impl BranchRenderError {
    pub(in crate::daemon::handlers::deploy) fn code(&self) -> &'static str {
        match self {
...
pub(in crate::daemon::handlers::deploy) fn encode_branch_manifest_json(
...
pub(in crate::daemon::handlers::deploy) fn stable_fingerprint<T: serde::Serialize>(
    value: &T,
) -> String {
