...
pub fn machine_role_service(machine_id: &MachineId) -> NatsServiceSpec {
    machine_role_service_spec(
        ...
        vec![
            ...
            machine_endpoint_spec(machine_id, MachineServiceEndpoint::StoragePrepare),
            machine_endpoint_spec(machine_id, MachineServiceEndpoint::StoragePrepareCancel),
            machine_endpoint_spec(machine_id, MachineServiceEndpoint::StoragePrepareReport),
...
pub const fn machine_endpoint_name(endpoint: MachineServiceEndpoint) -> &'static str {
    match endpoint {
        ...
        MachineServiceEndpoint::StoragePrepareCancel => "machine.storage.prepare.cancel",
        ...
        MachineServiceEndpoint::BuildCachePruneStart => "machine.build.cache.prune.start",
        MachineServiceEndpoint::BuildCachePruneStatus => "machine.build.cache.prune.status",
        MachineServiceEndpoint::BuildCachePruneCancel => "machine.build.cache.prune.cancel",
