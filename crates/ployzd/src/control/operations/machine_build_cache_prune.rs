...
use ployz_core::operation::{
    ...
    MachineBuildCachePruneTransition, OperationKind,
};
...
impl MachineBuildCachePruneOperation {
    ...
    #[tracing::instrument(name = "operation", skip_all, fields(kind = OperationKind::MachineBuildCachePrune.as_str(), operation_id = accepted.operation_id.as_str()))]
