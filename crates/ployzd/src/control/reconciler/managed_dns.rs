...
enum StepError {
    ...
    #[error(transparent)]
    Store(#[from] crate::control::store::CoreStoreError),
...
pub enum ManagedDnsTaskError {
    #[error(transparent)]
    Intent(#[from] crate::control::intent::ingress_intent::IngressIntentStoreError),
    #[error(transparent)]
    Store(#[from] crate::control::store::CoreStoreError),
    ...
    #[error(transparent)]
    Status(#[from] crate::control::operation_evidence::OperationStatusStoreError),
    #[error("system clock: {message}")]
    Clock { message: String },
}

impl From<crate::control::operation_evidence::SubmitOperationError> for ManagedDnsTaskError {
    fn from(error: crate::control::operation_evidence::SubmitOperationError) -> Self {
        Self::Submit {
