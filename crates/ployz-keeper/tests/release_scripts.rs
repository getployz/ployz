...
fn release_asset_verifier_rejects_asset_url_outside_release() {
    ...
    replace_in_file(
        &assets_dir.join("ployz-release-linux-amd64.env"),
        "PLOYZCTL_URL=https://github.com/getployz/ployz/releases/download/v0.0.2-alpha.1/ployzctl-linux-amd64",
        "PLOYZCTL_URL=https://github.com/getployz/ployz/releases/download/v0.0.3-alpha.1/ployzctl-linux-amd64",
    );
    ...
    assert_stderr_contains(
        &output,
        "expected https://github.com/getployz/ployz/releases/download/v0.0.2-alpha.1/ployzctl-linux-amd64",
    );
}
...
fn release_asset_verifier_rejects_swapped_asset_url_inside_release() {
    ...
    replace_in_file(
        &assets_dir.join("ployz-release-linux-amd64.env"),
        "PLOYZCTL_URL=https://github.com/getployz/ployz/releases/download/v0.0.2-alpha.1/ployzctl-linux-amd64",
        "PLOYZCTL_URL=https://github.com/getployz/ployz/releases/download/v0.0.2-alpha.1/ployz-keeper-linux-amd64",
    );
...
fn release_asset_verifier_rejects_asset_sha_mismatch() {
    ...
    replace_in_file(
        ...
        &format!("PLOYZCTL_SHA256={EMPTY_SHA256}"),
        "PLOYZCTL_SHA256=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
    );
