...
use ployz_sdk_types::{
    AcceptedOperation, EbpfAttachmentStatus, InternalDnsResolverStatus, NetworkDataplaneTestimony,
...
use crate::execution_support::generate_client_network_repair_id;
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct NetworkRepairOutput {
    pub accepted: AcceptedOperation,
}

impl NetworkRepairOutput {
    #[must_use]
