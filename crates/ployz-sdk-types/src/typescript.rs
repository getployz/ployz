...
use crate::{
    ...
    CertificateProvisionFailure, CloudBootstrapAttemptId, CloudBootstrapCallbackAccepted,
    ...
    ImageReference, ImageSource, IngressEndpointProjection, IngressEndpointProjectionIdentity,
