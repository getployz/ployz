...
use crate::{
    ...
    AutomaticHostnameLabel, AutomaticHostnameSuffix, BuildAdapter, BuildAdapterKind,
    BuildAdapterToolchainEvidence, BuildCachePruneEvidence, BuildCacheScope, BuildCancelError,
    BuildCancelRequest, BuildCleanupEvidence, BuildContextPath, BuildExecutorAssignment,
    BuildExecutorAssignments, BuildExecutorCapability, BuildExecutorCredentialExpiresAt,
    BuildExecutorEvidence, BuildExecutorId, BuildExecutorIdentity, BuildExecutorOrigin,
    BuildExecutorReadiness, BuildExecutorReadinessAnswer, BuildInterruptionStage, BuildLogChunk,
    BuildOperationFailure, BuildOperationState, BuildPlatformExecutorAssignment,
    BuildPlatformFailure, BuildPlatforms, BuildPoolId, BuildSource, BuildSourceEvidence,
    BuildSubmitError, BuildSubmitRequest, BuildTarget, BuildTargetCapabilities,
    BuildTargetCapabilitiesError, BuildTargetCapabilitiesRequest, BuildTimeoutFailure,
    BuildToolchainEvidence, CLOUD_BOOTSTRAP_PROTOCOL_VERSION, CancellationReason, CertBundleRef,
    CertId, CertInterruptionStage, CertOperationFailure, CertOperationState, CertRunningStage,
    CertValidAt, CertValidityWindow, CertificateInterruptionNextAction, CertificateOwner,
    CertificateProvisionFailure, CertificateProvisionWarning, CloudBootstrapAttemptId,
    ...
    CloudJoinerBootstrap, CloudJoinerBootstrapResult, ClusterBuildMachineCapability,
    ClusterBuildTargetCapabilities, ContainerCommand, ContainerEntrypoint, ContainerHealth,
    ContainerHealthcheck, ContainerHealthcheckTest, ContainerId, ContainerMountPath,
    ContainerResourceLimits, ContainerRestartPolicy, ContainerRetentionCount, ContainerRuntimeSpec,
    ...
    ControlIngressEndpointProjectionHealth, ControlNatsAuthorizationHealth,
    ...
    DatasetName, DatasetNameError, DatasetQuotaFact, DependencyCondition, DeployCleanupAction,
    ...
    DeployPreviewTarget, DeployRequest, DeployRequestEvidence, DeployReservationExpiresAt,
    DeployReservationId, DeployReserveError, DeployReserveRequest, DeployReserveResponse,
    DeployReserved, DeployRoute, DeployRouteTarget, DeployRunContainerStep, DeployRunningStage,
    DeployServicePlacement, DeployServicePlan, DeployServiceResult, DeployServiceSpec,
    DeployServiceWork, DeploySubmitError, DeploySubmitRequest, DeploySubmitResponse,
    DeployVolumeHandoffApplied, DeployVolumeHandoffAppliedParticipant,
    DeployVolumeHandoffParticipant, DeployVolumeHandoffPriorState,
    ...
    JoinTokenRedeemedAt, LinuxCapability, LocalSnapshotDigest, LogsTailError, LogsTailLines,
    ...
    MachineAddRequest, MachineAddResponse, MachineBootstrapUrl, MachineBuildCachePruneError,
    MachineBuildCachePruneFailure, MachineBuildCachePruneOperationState,
    MachineBuildCachePruneRequest, MachineContainerAvailability, MachineContainerUnavailableReason,
    MachineCredentialProvisioningStep, MachineDataplaneStatus, MachineDiskSpace,
    MachineEndpointObservation, MachineEndpointSubnet, MachineEndpointSupernet,
    ...
    MachineStoragePrepareError, MachineStoragePrepareFailure, MachineStoragePrepareOperationState,
    MachineStoragePrepareRequest, MachineSubstrateVersions, MachineTestimony, MachineUpdateError,
    MachineUpdateFailure, MachineUpdateOperationState, MachineUpdateRequest, MachineUpdateResponse,
    MachineUsabilityReason, ManagedContainerHealthStatus, ManagedContainerIdentity,
    ManagedContainerKind, ManagedContainerObservation, ManagedDnsReconcileFailure,
    ManagedDnsReconcileFailureClass, ManagedDnsReconcileOperationState, ManagedDnsReconcileSubject,
    ManagedDnsWithdrawAuthorization, ManagedLeaseName, MemoryBytes, NamespaceId,
    NamespaceRemoveError, NamespaceRemoveFailure, NamespaceRemoveOperationState,
    NamespaceRemoveRequest, NamespaceRemoveRunningStage, NamespaceRevisionEntryId,
    NamespaceRevisionId, NanoCpus, NativeDataplaneProjectionStatus, NatsAuthorizationGrant,
    NatsInternalAuthority, NatsPrincipal, NatsServerInstallSpec, NatsUserPublicKey,
    NetworkDataplaneTestimony, NetworkInternalDnsTestimony, NetworkRepairDnsRefreshProblem,
    NetworkRepairError, NetworkRepairFailure, NetworkRepairMachineFactsRefreshOutcome,
    NetworkRepairOperationState, NetworkRepairProgressPhase, NetworkRepairRequest,
    NetworkRepairRequestFailure, NetworkRepairRunningStage, NetworkResolveError,
    NetworkResolveMachineTestimony, NetworkResolveRequest, NetworkResolveResult,
    NetworkStatusError, NetworkStatusIntentFingerprint, NetworkStatusMachine, NetworkStatusMode,
    NetworkStatusRequest, NetworkStatusResult, NonEmptyAppliedVolumeHandoffParticipants,
    NonEmptyVolumeHandoffParticipants, NonEmptyVolumeNames, OciDigest, OciPlatform,
    OperationApiResponse, OperationEvent, OperationEventRecordedAtUnixMs,
    OperationEventReplayCursor, OperationEventReplayLimit, OperationEventReplayPage,
    OperationEventReplayRequest, OperationId, OperationIdempotencyKey, OperationInterruptionCause,
    ...
    PloyzNativeMeshReady, PoolCapacityFacts, PreStartHook, PreStartHookFailure, PreStartHookStep,
    PushedImageReceipt, RailpackCacheKey, RegistryCredential, RegistryCredentialSecret,
    RegistryCredentialUsername, ReleasePlatformFailure, ReplayedOperationEvent, ReplicaCount,
    ReplicaSlot, ReplicatedReplicaSlot, RetainedArtifact, RouteBindingId, RouteBindingOrigin,
    RouteBindingState, RouteCutoverFailureReason, RouteHostname, RoutePort, RouteTarget,
    RouteTlsAvailability, RouteTlsStatus, RuntimeDerivedCollectionSource,
    ...
    ServiceEnvironmentNames, ServiceId, ServiceInspectError, ServiceInspectRequest,
    ServiceListError, ServiceListRequest, ServiceListResult, ServiceMachineTestimony, ServiceMode,
    ServiceRestartError, ServiceRestartFailure, ServiceRestartOperationState,
    ServiceRestartRequest, ServiceRestartRunningStage, ServiceSnapshot, ServiceTestimony,
    ServiceVolumeMount, ServingTargetEntry, StepId, StopGracePeriod, StorageCapability,
    StorageEffectFailure, StorageUnavailableReason, StrandedVolumeAlarm, StrandedVolumeReason,
    SystemDeployRequest, SystemDeployTarget, UnusableMachine, VerifiedBuildSource,
    VerifiedGitCommit, VolumeAdmissionFailure, VolumeCreateError, VolumeCreateFailure,
    VolumeCreateOperationState, VolumeCreateRequest, VolumeCreateRunningStage, VolumeEnsureFailure,
    VolumeKind, VolumeListError, VolumeListRequest, VolumeListResult, VolumeMaxSizeBytes,
    VolumeName, VolumePinState, VolumeRemoveError, VolumeRemoveFailure, VolumeRemoveOperationState,
...
macro_rules! exported_types {
    ($macro:ident) => {
        $macro!(
            ...
            BuildExecutorCapability,
            BuildExecutorReadiness,
            BuildExecutorReadinessAnswer<BuildExecutorReadiness>,
            BuildAdapterKind,
            BuildExecutorCredentialExpiresAt,
            BuildTarget,
            BuildTargetCapabilitiesRequest,
            BuildTargetCapabilities,
            BuildTargetCapabilitiesError,
            ClusterBuildTargetCapabilities,
            ClusterBuildMachineCapability,
            ExternalBuildPoolCapabilities,
            ExternalBuildExecutorCapability,
            BuildExecutorOrigin,
            BuildExecutorAssignment,
            BuildExecutorAssignments,
            ...
            NonEmptyAppliedVolumeHandoffParticipants,
            NonEmptyVolumeHandoffParticipants,
            NonEmptyVolumeNames,
            DeployServicePlacement,
            DeployPhaseNumber,
            DeployPhaseOutcome,
            DeployServiceResult,
            PreStartHookStep,
            ...
            OperationSubject,
            BuildOperationState,
            BuildInterruptionStage,
            BuildAdapterToolchainEvidence,
            ...
            VolumeCreateOperationState,
            VolumeCreateRunningStage,
            VolumeCreateFailure,
            VolumeAdmissionFailure,
            DatasetNameError,
            VolumeEnsureFailure,
            ...
            DeployVolumeHandoffRestartFailure,
            DeployVolumeHandoffRestorationUnconfirmed,
            DeployVolumeHandoffRollbackOutcome,
            DeployVolumeHandoffRollbackContainerOutcome,
            HealthCheckFailure,
            ...
            MachineContainerUnavailableReason,
            MachineSnapshot,
            MachineTestimony,
            DatasetQuotaFact,
            PoolCapacityFacts,
            ...
            ControlHealth,
            ControlNatsAuthorizationHealth,
            ...
            MachineStoragePrepareCancelRequest,
            MachineStoragePrepareCancelError,
            MachineBuildCachePruneOperationState,
            BuildCachePruneEvidence,
            MachineBuildCachePruneFailure,
            MachineBuildCachePruneRequest,
            MachineBuildCachePruneError,
...
pub fn operation_contract_fixture() -> Value {
    ...
    let replay_page = OperationEventReplayPage {
        events: vec![ReplayedOperationEvent {
            ...
            event: OperationEvent::DeploySubmitted {
                ...
                target: DeployRequestEvidence::from_request(&deploy_target),
            },
        }],
    ...
    json!({
        ...
        "deploy_preview_volume_admission_failed_response": value(
            DeployPreviewResponse::DomainError {
                error: DeployPreviewError::VolumeAdmissionFailed {
                    service_id: service_id("svc_api"),
                    machine_id: machine_id("machine_2"),
