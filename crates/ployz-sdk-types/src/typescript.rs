...
use crate::{
    ...
    MachineEndpointSubnet, MachineId, MachineInspectError,
    ...
    MachineLifecycleOperationState, MachineLifecycleRequest, MachineListError, MachineListRequest, MachineListResult,
    MachineName, MachinePublicIpObservation, MachineReadinessCheck, MachineReadinessEvidence,
    MachineSnapshot, MachineSubstrateVersions, MachineUpdateError,
