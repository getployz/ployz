...
use crate::{
    ...
    NetworkDataplaneTestimony, NetworkInternalDnsTestimony, NetworkRepairError,
    NetworkRepairFailure, NetworkRepairMachineFactWatermark, NetworkRepairOperationState,
    NetworkRepairRequest, NetworkRepairRunningStage, NetworkResolveError,
    ...
    WireGuardConfiguredMtu, WireGuardDetectedMtu, WireGuardHandshakeStatus, WireGuardMtuProbe,
    WireGuardPeerStatus, WireGuardPublicKey, WireGuardReady, WireGuardReadyEvidence,
    WireGuardRttStatus, WireGuardStatus, WrappedCaKey, WrappedCoreSeeds,
};
...
macro_rules! exported_types {
    ($macro:ident) => {
        $macro!(
            ...
            NetworkRepairMachineFactWatermark,
