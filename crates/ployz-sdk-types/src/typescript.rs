...
use crate::{
    ...
    MachinePublicIpObservation, MachineReadinessCheck, MachineReadinessEvidence, MachineSnapshot,
    MachineSubstrateVersions, MachineUpdateError, MachineUpdateFailure,
    MachineUpdateOperationState, MachineUpdateRequest, MachineUpdateResponse,
    ManagedContainerIdentity, ManagedContainerKind, ManagedContainerObservation, NamespaceId,
    NamespaceRevisionEntryId, NamespaceRevisionId, NatsServerInstallSpec, NatsUserPublicKey,
    ...
    ServiceSnapshot, ServingTargetEntry, StepId, WireGuardPublicKey, WireGuardReady,
