...
use crate::{
    ...
    CertValidityWindow, CertificateProvisionFailure, CloudBootstrapAttemptId,
    ...
    JoinTokenExpiresAt, JoinTokenFingerprint, JoinTokenRedeemedAt, LeaseBearerToken,
    LeaseExpiresAt, LeaseIssuedAt, LinuxCapability, LogsTailError, LogsTailLines, LogsTailRequest,
    ...
    MachineUsabilityReason, ManagedCertBundle, ManagedCertificateIssuanceFailureKind,
    ManagedContainerHealthStatus, ManagedContainerIdentity, ManagedContainerKind,
    ManagedContainerObservation, ManagedLeaseAcquireRequest, ManagedLeaseAcquired,
    ManagedLeaseAcquisitionId, ManagedLeaseAddressSet, ManagedLeaseFailureClass, ManagedLeaseName,
    ManagedLeaseOperationFailure, ManagedLeaseOperationState, ManagedLeaseRecord,
    ManagedLeaseRenewRequest, ManagedLeaseRenewed, ManagedLeaseSubject, ManagedPublicUrlPending,
    ManagedPublicUrlPendingStage, MemoryBytes, NamespaceId, NamespaceRemoveError,
    ...
    NativeDataplaneProjectionStatus, NatsAuthorizationGrant, NatsInternalAuthority, NatsPrincipal,
    NatsServerInstallSpec, NatsUserPublicKey, NetworkDataplaneTestimony,
    NetworkInternalDnsTestimony, NetworkRepairDnsRefreshProblem, NetworkRepairError,
    ...
    OpsWatchError, OpsWatchResponse, PidsLimit, PloyzNativeMeshComponent, PloyzNativeMeshReady,
    PreStartHook, PreStartHookFailure, PreStartHookStep, PublicUrlMode, RegistryCredential,
    RegistryCredentialSecret, RegistryCredentialUsername, ReplayedOperationEvent, ReplicaCount,
    ReplicaSlot, RetainedArtifact, RouteBindingState, RouteCertLifecycle, RouteCertStatus,
    ...
    ServiceListError, ServiceListRequest, ServiceListResult, ServiceMachineTestimony,
    ...
    ServiceVolumeMount, ServingTargetEntry, StepId, StopGracePeriod, UnusableMachine,
    VolumeListError, VolumeListRequest, VolumeListResult, VolumeName, VolumePinState,
    VolumeRemoveError, VolumeRemoveFailure, VolumeRemoveOperationState, VolumeRemoveRequest,
    VolumeRemoveRunningStage, VolumeSnapshot, VolumeStatus, WireGuardConfiguredMtu,
...
macro_rules! exported_types {
    ($macro:ident) => {
        $macro!(
            ...
            CertBundleRef,
            ManagedLeaseName,
            ManagedLeaseAcquisitionId,
            LeaseBearerToken,
            LeaseIssuedAt,
            LeaseExpiresAt,
            ManagedLeaseRecord,
            ManagedCertBundle,
            ManagedCertificateIssuanceFailureKind,
            ManagedPublicUrlPendingStage,
            ManagedPublicUrlPending,
            ManagedLeaseAddressSet,
