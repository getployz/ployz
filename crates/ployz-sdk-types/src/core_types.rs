...
pub use ployz_core::deploy::{
    ...
    EnvValueFingerprint, EnvValueFingerprintError, HealthcheckDurationNanos, HealthcheckRetries,
    ...
    ReplicatedReplicaSlot, ServiceDependency, ServiceEnvironment, ServiceEnvironmentEvidence,
