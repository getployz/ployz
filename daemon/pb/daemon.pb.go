...
type GetStatusResponse struct {
	...
	NetworkPhase string `protobuf:"bytes,3,opt,name=network_phase,json=networkPhase,proto3" json:"network_phase,omitempty"`
...
func (x *GetStatusResponse) GetNetworkPhase() string {
	if x != nil {
