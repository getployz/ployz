...
// nopCloser satisfies net.Conn for HijackedResponse.
type nopCloser struct{}

func (nopCloser) Read([]byte) (int, error)        { return 0, io.EOF }
func (nopCloser) Write(b []byte) (int, error)      { return len(b), nil }
func (nopCloser) Close() error                     { return nil }
func (nopCloser) LocalAddr() net.Addr              { return nil }
func (nopCloser) RemoteAddr() net.Addr             { return nil }
func (nopCloser) SetDeadline(time.Time) error      { return nil }
func (nopCloser) SetReadDeadline(time.Time) error  { return nil }
func (nopCloser) SetWriteDeadline(time.Time) error { return nil }
...
func TestDown_WrapsStopError(t *testing.T) {
	...
	docker := &fakeDocker{stopErr: stopErr}
	wg := newTestWG(t, docker)
