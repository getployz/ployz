...
export type MachineAddAccepted = { accepted: AcceptedOperation, node_id: NodeId, bootstrap_url: MachineBootstrapUrl, bootstrap_nats_url: MachineJoinRuntimeNatsUrl, join_token: MachineJoinToken, };
