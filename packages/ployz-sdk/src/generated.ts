...
export type BuildPlatformFailure = { "kind": "machine_unavailable", message: FailureMessage, } | { "kind": "buildkit_digest_mismatch", expected: OciDigest, actual: OciDigest, } | { "kind": "helper_digest_mismatch", expected: InstallSha256Digest, actual: InstallSha256Digest, } | { "kind": "frontend_digest_mismatch", expected: OciDigest, actual: OciDigest, } | { "kind": "platform_mismatch", expected: OciPlatform, actual: OciPlatform, } | { "kind": "source_fetch_failed", message: FailureMessage, } | { "kind": "adapter_failed", message: FailureMessage, } | { "kind": "image_push_failed", message: FailureMessage, };
...
export type OperationKind = "build" | "deploy" | "cert" | "machine_add" | "machine_update" | "machine_storage_prepare" | "machine_lifecycle" | "core_replace" | "credential_grant" | "network_repair" | "service_restart" | "managed_dns_reconcile" | "ingress_configure" | "namespace_remove" | "volume_create" | "volume_remove";
