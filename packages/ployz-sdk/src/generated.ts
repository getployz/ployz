...
export type BuildOperationFailure = { "kind": "no_eligible_machine", platform: OciPlatform, unusable: Array<UnusableMachine>, } | { "kind": "platform_failed", platform: OciPlatform, machine_id: MachineId, failure: BuildPlatformFailure, } | { "kind": "receipt_assembly_failed", message: FailureMessage, };
...
export type OperationKind = "build" | "deploy" | "cert" | "machine_add" | "machine_update" | "machine_storage_prepare" | "machine_lifecycle" | "core_replace" | "credential_grant" | "network_repair" | "service_restart" | "managed_dns_reconcile" | "ingress_configure" | "namespace_remove" | "volume_remove";
