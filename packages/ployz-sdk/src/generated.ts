...
export type NetworkRepairFailure = { "kind": "no_active_machines" } | { "kind": "target_machine_not_found", machine_id: MachineId, } | { "kind": "intent_read_failed", message: FailureMessage, } | { "kind": "dataplane_convergence_failed", machine_id: MachineId, component: PloyzNativeMeshComponent, message: FailureMessage, } | { "kind": "dataplane_report_invalid", message: FailureMessage, } | { "kind": "machine_facts_refresh_unavailable", machine_id: MachineId, message: FailureMessage, } | { "kind": "machine_facts_refresh_failed", machine_id: MachineId, message: FailureMessage, } | { "kind": "dns_refresh_unavailable", machine_id: MachineId, message: FailureMessage, } | { "kind": "dns_refresh_stale", machine_id: MachineId, stale_machine_ids: Array<MachineId>, };

export type NetworkRepairMachineFactWatermark = { machine_id: MachineId, observed_at_unix_ms: number, };
