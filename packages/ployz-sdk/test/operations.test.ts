...
test("sdk exports the Rust operation API contract registry", () => {
  assert.deepEqual(OPERATION_API_CONTRACTS, [
    ...
    },
    {
      ...
      subject: "plz.v1.rpc.operator.command.machine.storage_prepare",
      execution: "accepts_operation",
    ...
    {
      name: "credential.add",
      subject: "plz.v1.rpc.operator.command.credential.add",
      execution: "accepts_operation",
      request: "CredentialAddRequest",
      success: "AcceptedOperation",
      error: "CredentialAddError",
      response: "CredentialAddResponse",
    },
    {
      name: "credential.list",
      subject: "plz.v1.rpc.operator.query.credential.list",
      execution: "query",
    ...
    },
    {
      ...
      subject: "plz.v1.rpc.operator.command.credential.remove",
      execution: "accepts_operation",
    ...
    },
    {
      ...
      response: "NetworkResolveResponse",
    },
    {
      name: "network.repair",
      subject: "plz.v1.rpc.operator.command.network.repair",
      execution: "accepts_operation",
      request: "NetworkRepairRequest",
      success: "AcceptedOperation",
      error: "NetworkRepairError",
      response: "NetworkRepairResponse",
    },
    {
      name: "machine.redeem",
    ...
    machine_snapshots: [
      {
        active: {
          ...
          roles: { gateway: "install" as const },
          control_endpoints: [],
          mesh_endpoints: [],
